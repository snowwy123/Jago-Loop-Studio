...
*/
const WIGGLY_KEY='jago-loop-studio-v2';
const LEGACY_KEY='wigglypaint-studio-v1';
...
function saveLocal(){try{localStorage.setItem(WIGGLY_KEY,snapshot());dirty=false;autosaveFailed=false;$('saveState').textContent='Saved on this device';}catch(e){if(!autosaveFailed)toast('Browser storage is full or unavailable. Use Save to keep a project file.');autosaveFailed=true;$('saveState').textContent='Save a project file';}}
