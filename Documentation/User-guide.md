...
Artwork already flattened by an older version cannot regain its lost stroke data. Use Undo in that session or reopen a project saved before the move. New saves use schema 4 and require v1.0.3 or later; earlier .jago and .wiggly files still open.
