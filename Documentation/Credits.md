...
- [WigglyPaint - original creator's project page](https://internet-janitor.itch.io/wigglypaint)
- [Decker - John Earnest's source repository](https://github.com/JohnEarnest/Decker)
...
The Windows shell uses **Microsoft WebView2 SDK 1.0.4191.47**. Microsoft's copyright, license and third-party notices are preserved in:

- [WebView2-LICENSE.txt](../Notices/WebView2-LICENSE.txt)
- [WebView2-NOTICE.txt](../Notices/WebView2-NOTICE.txt)

The same notices are embedded in the executable and extracted beside its supporting components at launch. The Microsoft WebView2 Runtime is a separate installed component.
